...
def initiate(agent_num, space_x, space_y, Target_size):
    ...
    swarm[:, 12] = 3             # K_repulsion avoid shepherd  2.8 0.5 0.8 1.8 2.5
...
def initiate_shepherd(N_shepherd, agent_num):
    ...
    shepherd_swarm[:, 5] = 7.5*(np.sqrt(agent_num))    # L1: drive point: from shepherd to mass center(40 Ns = 50)(50 N=100)(75 N = 200)#59 N = 250
    shepherd_swarm[:, 6] = 4               # v0    #4
    ...
    shepherd_swarm[:, 12] = 7.5*(np.sqrt(agent_num))    # L2: collect mode: Furthest agent to mass (35 Ns = 50) (60 Ns=100)(75 Ns = 200)# 59 N = 250
