...
def initiate_shepherd(N_shepherd, agent_num, L3):
    ...
    shepherd_swarm[:, 5] = 15*(np.sqrt(agent_num))*2/3  #7.5*(np.sqrt(agent_num))*2/3    # L1: drive point: from shepherd to mass center(40 Ns = 50)(50 N=100)(75 N = 200)#59 N = 250
    ...
    shepherd_swarm[:, 12] = 15*(np.sqrt(agent_num))*2/3 #7.5*(np.sqrt(agent_num))*2/3 # 7.5 = 2.5*3 # L2: d_furthest in collect mode:(35 Ns = 50)(50 Ns=100)(70.7 Ns = 200)
